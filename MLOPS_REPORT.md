...
- Phase 2 bốn jobs xanh, tự động kích hoạt bởi push con trỏ DVC:
  https://github.com/longkhongbietcode/K3-Track2-Day21-ThieuVanLong-2A202601489/actions/runs/32492303559
...
credentials được export chỉ trong bộ nhớ tiến trình. Repository là một fork
nên Actions phải được bật lại ở cấp repository; sau khi bật và sửa trigger
thành `data/*.dvc`, commit con trỏ DVC đã tự động chạy đủ bốn jobs.
